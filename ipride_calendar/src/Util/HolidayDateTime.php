...
//Refer to: http://qiita.com/chiyoyo/items/539dc2840a1b70a8e2c3
/**
...
class HolidayDateTime extends DateTime {
  ...
  private function happyHoliday($month, $week, $start, $end, $name) {
    ...
    $d1 = clone $this;
    $d1->setDate($this->year, $this->month, 1);
  ...
  public function getWeekdayJp() {
    $weekday = $this->dayOfWeek;
    $weekday_jps = ['日', '月', '火', '水', '木', '金', '土'];
    return $weekday_jps[$weekday];
  }
  ...
  public function getTimeOfDayInMin() {
    return $this->hour * 60 + $this->minute;
  }

  public function getMonthDayJp() {
    return $this->format("n月j日");
  }
